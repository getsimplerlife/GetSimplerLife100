    ...
    <div className="space-y-12 p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-3xl p-6 shadow-sm flex flex-col justify-between gap-6 hover:border-emerald-500/20 transition-all">
          ...
          <button onClick={() => handleDownload("stripe_portal")} className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs py-3 rounded-xl shadow-lg transition-all">💳 Manage via Stripe Portal</button>
        </div>
      ...
      <div className="space-y-8 pt-6 border-t border-stone-200 dark:border-stone-800">
        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: "Additional AI Agent", desc: "Deploy an extra dedicated agent loop tailored for unique operational tasks.", price: "$1,500", link: "https://buy.stripe.com/00w14pcp957VghR4DC2Fa1x", icon: "🤖" },
              { name: "CRM Integration", desc: "Sync your digital coworkers directly into Salesforce, HubSpot, or Zoho.", price: "$2,000", link: "https://buy.stripe.com/3cI6oJexh1VJ3v55HG2Fa1y", icon: "🔌" },
              { name: "ERP Integration", desc: "Wire advanced inventory and resource data into SAP, NetSuite, or Oracle.", price: "$3,500", link: "https://buy.stripe.com/9B6bJ39cX8k79Tteec2Fa1z", icon: "🏭" },
              { name: "Voice AI Receptionist", desc: "Deploy high-fidelity, autonomous voice lines handling inbound call reception.", price: "$2,500", link: "https://buy.stripe.com/6oU9AV88TgQDfdN6LK2Fa1A", icon: "📞" },
              { name: "AI Sales Assistant", desc: "Automatically draft outreach, sync pipelines, and follow up warm leads.", price: "$2,000", link: "https://buy.stripe.com/eVqdRb0Gr6bZ7Ll0nm2Fa1B", icon: "📈" },
              { name: "AI Customer Support Agent", desc: "Provide real-time email, ticket, and chat resolutions under 5 minutes.", price: "$1,800", link: "https://buy.stripe.com/eVq9AVgFpasffdN2vu2Fa1C", icon: "🤝" },
              { name: "Custom Dashboard", desc: "Gain real-time executive analytics, ROI calculators, and system health status.", price: "$1,500", link: "https://buy.stripe.com/cNibJ31Kv2ZN0iT6LK2Fa1D", icon: "📊" },
              { name: "Document AI System", desc: "Extract unstructured invoice, fax, or contract data with 100% precision.", price: "$2,500", link: "https://buy.stripe.com/14A3cxfBl1VJfdN2vu2Fa1E", icon: "📄" },
