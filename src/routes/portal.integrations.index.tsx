...
function ConnectedServices() {
  ...
  const [loadingConns, setLoadingConns] = useState(false); // providers render immediately; connections refresh client-side
  ...
  const triggerFileUpload = async (file: File) => {
    ...
    // Progress tracking for extraction pipeline
    const steps = [
