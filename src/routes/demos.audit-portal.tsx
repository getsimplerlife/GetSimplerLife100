        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-12">
            ...
            <div className="p-8 bg-emerald-900 rounded-[2rem] text-white">
              ...
              <a href="https://buy.stripe.com/aFa8wRdtd0RF5Dd8TS2Fa1t" className="inline-block bg-stone-950 text-emerald-900 px-8 py-3 rounded-xl font-bold hover:bg-emerald-50 transition-colors">
                Book Audit Now
              </a>
            </div>
          </div>
