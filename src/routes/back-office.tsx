...
const subWorkflows = [
  {
    ...
    description: "AI ledger agents receive raw billing details, match bills with Purchase Orders and Proof of Deliveries, categorize ledger accounts, and draft secure payments for approval. Automate invoice aging follow-ups completely.",
    metric: "Processes 95% of invoices with zero touch"
  },
  {
    id: "data-entry",
    title: "Manual Data Entry",
    description: "Connect disjointed legacy systems, spreadsheets, CRM, and ERP pipelines. AI agents monitor incoming data sources and update target entries with perfect field accuracy, performing strict cross-checks.",
    metric: "Eliminates human entry errors by 100%"
  },
  {
    id: "compliance-reporting",
    title: "Compliance Reporting",
    description: "Scan regulatory filings, trade documentation, tax sheets, and standard certificates. Systematically cross-reference them against government state databases and industry frameworks to auto-draft reports.",
    metric: "Saves up to 10 labor hours weekly"
  },
  {
    id: "document-processing",
    title: "Document Processing",
    description: "Handle high-volume customer intakes, vendor questionnaires, multi-page PDFs, and complex contract sheets. Synthesize unstructured paperwork into crisp JSON outputs ready for any software API.",
    metric: "Extracted in under 3 seconds per page"
  },
  {
    id: "invoice-reconciliation",
    title: "Invoice Reconciliation",
    description: "Automatically match bank statements, credit card logs, and payment processor records against internal ledger invoices. Quickly isolates discrepancies, detention fees, and payment gaps for swift resolution.",
    metric: "Over 85% reduction in aging balances"
  }
];
...
const packages = [
  {
    name: "Starter Team",
    price: "$7,500",
    description: "Perfect for automating 1-2 core back-office sub-workflows (e.g. Invoice matching and AP entry).",
    features: ["2 active AI agents", "3 target workflows", "QuickBooks / ERP integration", "30-day dedicated support", "Fully secure encrypted data flow"],
    link: "https://buy.stripe.com/9B6eVe0wCcFe48ucot3Ru01"
  },
  {
    name: "Growth Team",
    price: "$15,000",
    description: "Best for comprehensive back-office operational sync, connecting accounts, data entry, and compliance reporting.",
    features: ["5 active AI agents", "Cross-department back-office workflows", "ERP + CRM + Bank APIs", "60-day dedicated support", "Advanced reconciliation dash"],
  ...
  },
  {
    name: "Scale Team",
    price: "$30,000",
    description: "Enterprise-grade complete end-to-end multi-currency AP/AR automation, audit, and customized data extraction suite.",
    features: ["Unlimited custom AI workflows", "Fully tailored multi-system agents", "Advanced API and custom legacy database hooks", "90-day custom dedicated engineering", "Human-in-the-loop audit logs UI"],
      ...
      <main className="pb-32">
        ...
        <section className="px-6 pt-20 pb-24 lg:pt-32 lg:pb-36 max-w-7xl mx-auto text-center relative">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl lg:text-7xl font-black tracking-tight mb-8 leading-[1.15]">
              Automate Your Repetitive <span className="text-emerald-400">Back Office Workflows</span>.
            </h1>
            <p className="text-xl lg:text-2xl text-stone-400 mb-12 leading-relaxed">
              Stop copy-pasting lines between tools, scanning document PDFs manually, and wasting labor hours on bank ledger reconciliations. Deploy custom-configured AI back-office coworkers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/audit-upload" className="bg-emerald-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-950/30">
                Submit Sample Workflows for Free Audit
              </Link>
        ...
        <section className="px-6 py-20 bg-stone-900/40 border-y border-stone-900 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg lg:text-xl text-stone-400 leading-relaxed">
              Back-office departments waste up to 35% of their working hours on raw copy-pasting, manually extracting tabular invoice values, resolving minor ledger mismatches, and filing routine compliance briefs. Our AI Back Office Team handles processing and ledger sync completely in the background.
            </p>
          </div>
        </section>
        ...
        <section id="workflows" className="px-6 py-24 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-black mb-4 tracking-tight">Tailored Back-Office Workflows</h2>
            <p className="text-lg text-stone-400 max-w-2xl mx-auto">
              Our active AI agents plug natively into tools like QuickBooks, NetSuite, SAP, Salesforce, email queues, and shared folders to execute workflows automatically.
            </p>
          </div>
        ...
        <section className="px-6 py-24 bg-stone-900/30 border-t border-stone-900">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-black mb-4 tracking-tight">Deploy Your AI Back Office Team</h2>
              <p className="text-lg text-stone-400 max-w-2xl mx-auto">
                Flat-rate simple pricing structures. Reclaim thousands of administrative hours today.
              </p>
            </div>
