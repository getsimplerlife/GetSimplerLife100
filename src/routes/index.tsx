...
const auditTiers = [
  ...
  },
  {
    ...
    features: ["2-3 week full diagnostic", "Vertical-specific waste audit", "Cost savings analysis report", "Credit toward implementation"],
...
const implementationPackages = [
  {
    ...
    features: ["2 AI agents", "3 custom workflows", "CRM, email, & docs integration", "30 days priority support"],
  ...
  },
  {
    ...
    features: ["5 AI agents", "Full dept. cross-workflows", "CRM + ERP integrations", "Dashboards & training", "60 days support"],
  ...
  },
  {
    ...
    features: ["Unlimited workflows", "Custom trained agents", "Advanced integrations", "Exec reporting & PM", "90 days support"],
...
const monthlyOps = [
  {
    ...
    features: ["24/7 uptime monitoring", "Bug fixes & maintenance", "Prompt & model updates", "Monthly optimization report"],
  ...
  },
  {
    ...
    features: ["Everything in Essential", "New minor automations", "Model improvements", "Monthly strategy call"],
