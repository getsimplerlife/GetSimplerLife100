      ...
      <header className="px-6 py-4 border-b bg-stone-950 dark:bg-stone-900 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <span className="text-xs font-bold text-stone-400 uppercase tracking-widest hidden sm:inline">Interactive Demo</span>
            <Link to="/" className="text-sm font-bold text-emerald-600 hover:text-emerald-700">Exit</Link>
          </div>
        </div>
      </header>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-12">
                ...
                >
                  <div className="relative z-10 flex gap-6">
                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 font-black text-xl ${
                      activeStep === step.id ? "bg-emerald-600 text-white" : "bg-stone-200 text-stone-500"
                    }`}>
                      {step.id}
                    </div>
            ...
            <div className="p-8 bg-emerald-900 rounded-[2rem] text-white">
              ...
              <a href="https://buy.stripe.com/4gMfZj88TfMz6Hh8TS2Fa1K" className="inline-block bg-stone-950 text-emerald-900 px-8 py-3 rounded-xl font-bold hover:bg-emerald-50 transition-colors">
                Book Audit Now
              </a>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-stone-950 dark:bg-stone-900 rounded-[2.5rem] shadow-2xl border-8 border-stone-900 dark:border-stone-800 aspect-[4/3] overflow-hidden flex flex-col">
                <div className="h-8 bg-stone-900 dark:bg-stone-800 flex items-center px-4 gap-1.5">
                  ...
                  <div className="ml-4 h-4 w-48 bg-stone-800 dark:bg-stone-700 rounded-full"></div>
                </div>
                  ...
                  {activeStep === 1 && (
                    <div className="max-w-sm mx-auto space-y-6">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-stone-400 text-sm">Simpler Life 100 Audit</p>
                      </div>
                      <div className="flex justify-between items-center py-4 border-b border-stone-100 dark:border-stone-800">
                      ...
                      <button className="w-full bg-emerald-600 text-white py-4 rounded-xl font-bold shadow-lg">Pay $2,500.00</button>
                    </div>
                  )}
                  ...
                  {activeStep === 2 && (
                    <div className="max-w-sm mx-auto space-y-6">
                      <div className="text-center mb-8">
                        ...
                        <p className="text-stone-400 text-sm mt-2">Secure your operational data.</p>
                      </div>
                      <div className="space-y-4">
                      ...
                      <button className="w-full bg-emerald-600 text-white py-4 rounded-xl font-bold">Initialize Portal</button>
                      <p className="text-center text-[10px] text-stone-400">By continuing, you agree to the Master Service Agreement.</p>
                    </div>
                  )}
                    ...
                    <div className="space-y-6">
                      <div className="flex justify-between items-end">
                        <div>
                          ...
                          <p className="text-stone-400 text-xs">SL-100-29384-BLUEPRINT</p>
                        </div>
                        <button className="text-[10px] font-black uppercase text-emerald-600 border border-emerald-200 px-3 py-1 rounded-lg">Download PDF</button>
                      </div>
                      ...
                      <div className="p-6 bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl border border-emerald-100 dark:border-emerald-800">
                        <div className="flex items-center justify-between mb-4">
                          <span className="text-xs font-black text-emerald-600 uppercase tracking-widest">Total Projected Savings</span>
                          <span className="text-2xl font-black text-emerald-900 dark:text-emerald-100">$142,400/yr</span>
                        </div>
                        <div className="h-px bg-emerald-100 dark:bg-emerald-800 mb-4"></div>
                        <div className="grid grid-cols-2 gap-4">
                          <div>
                            <div className="text-[10px] font-bold text-emerald-400 uppercase">Waste Points</div>
                            <div className="text-lg font-black">12 Critical</div>
                          </div>
                          <div>
                            <div className="text-[10px] font-bold text-emerald-400 uppercase">ROI Multiplier</div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="p-4 bg-stone-950 dark:bg-stone-800 rounded-xl border border-stone-100 dark:border-stone-700 flex items-center justify-between">
                          ...
                          <span className="text-[10px] font-black text-emerald-600">Growth Implementation</span>
                        </div>
                      </div>
                    </div>
                  )}
...
export default AuditPortalDemo;
