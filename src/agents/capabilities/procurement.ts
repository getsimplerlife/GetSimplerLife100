...
export interface ProcurementAdapter { listPurchaseOrders(tenantId: string): Promise<unknown>; createPurchaseOrder(tenantId: string, input: Record<string, unknown>, idempotencyKey: string): Promise<unknown>; }
