/**
 * AI Customer Support Agent Employee
 *
 * Handles incoming support tickets: classifies by urgency, generates contextual
 * AI replies, escalates to humans when needed, and tracks SLA compliance.
 */
