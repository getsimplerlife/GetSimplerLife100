...
import { docusignAdapter, hubspotAdapter, intercomAdapter, jiraAdapter, mondayComAdapter, salesforceAdapter, slackAdapter, tableauAdapter, workdayAdapter, zendeskAdapter } from "./priority";
