...
import { docusignAdapter, hubspotAdapter, intercomAdapter, jiraAdapter, mondayComAdapter, salesforceAdapter, servicenowAdapter, slackAdapter, tableauAdapter, workdayAdapter, zendeskAdapter } from "./priority";
