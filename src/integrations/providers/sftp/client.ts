...
export class SftpClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.sftp.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createSftpClient(config: ConnectionConfig): SftpClient { return new SftpClient(config); }
