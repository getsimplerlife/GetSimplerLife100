...
export class MongodbClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.mongodb.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createMongodbClient(config: ConnectionConfig): MongodbClient { return new MongodbClient(config); }
