...
export class XmlClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.xml.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createXmlClient(config: ConnectionConfig): XmlClient { return new XmlClient(config); }
