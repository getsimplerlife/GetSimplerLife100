...
export class PostgresqlClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.postgresql.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createPostgresqlClient(config: ConnectionConfig): PostgresqlClient { return new PostgresqlClient(config); }
