...
export class SoapClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.soap.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createSoapClient(config: ConnectionConfig): SoapClient { return new SoapClient(config); }
