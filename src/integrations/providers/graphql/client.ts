...
export class GraphqlClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.graphql.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createGraphqlClient(config: ConnectionConfig): GraphqlClient { return new GraphqlClient(config); }
