...
export class BigqueryClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.bigquery.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createBigqueryClient(config: ConnectionConfig): BigqueryClient { return new BigqueryClient(config); }
