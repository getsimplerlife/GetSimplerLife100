...
export class JsonClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.json.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createJsonClient(config: ConnectionConfig): JsonClient { return new JsonClient(config); }
