...
export class AirtableClient {
  ...
  constructor(config: any) {
    this.client = new HttpClient({ baseUrl: "https://api.airtable.com", rateLimit: { maxRequestsPerSecond: 10 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 });
  }
...
export function createAirtableClient(config: ConnectionConfig): AirtableClient { return new AirtableClient(config); }
