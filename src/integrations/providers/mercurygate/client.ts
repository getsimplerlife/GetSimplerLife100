...
export class MGClient {
  ...
  constructor(apiKey: string) {
    this.apiKey = apiKey; this.client = new HttpClient({ baseUrl: "https://api.mercurygate.com/v1", rateLimit: { maxRequestsPerSecond: 5 }, retry: { maxRetries: 3, baseDelay: 1000, maxDelay: 10000 }, timeout: 30000 }); }
