...
const GENERIC_READ_ENDPOINTS: Record<string, GenericEndpointDef> = {
  ...
  // Freshdesk requires API-key Basic authentication; generic reads only support bearer auth.
  // Fail closed until a dedicated, validated Freshdesk handler exists.
  "freshdesk": { unsupported: "Freshdesk requires API-key Basic authentication; no generic request was made." },
