...
var allInts=[];function filterInts(){var s=document.getElementById("int-search").value.toLowerCase();document.querySelectorAll(".integration-card").forEach(function(c){c.style.display=!s||c.dataset.name.indexOf(s)>-1||c.dataset.cat.indexOf(s)>-1?"":"none"})}
